    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($penjualans)
            ...
            ->addColumn('total_barang', function ($penjualan) {
                $total_barang = DetailModel::where('penjualan_id', $penjualan->penjualan_id)->sum('jumlah');
                return $total_barang;
            })

            ->addColumn('total_harga', function ($penjualan) {
                $total_harga = DetailModel::where('penjualan_id', $penjualan->penjualan_id)->sum('harga');
